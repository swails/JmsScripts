...
MaxBond = { 'H'  :  1, 'He' :  0, 'Li' :  1, 'Be' :  2, 'B'  :  3, 'C'  :  4, 
            'N'  :  3, 'O'  :  2, 'F'  :  1, 'Ne' :  0, 'Na' :  1, 'Mg' :  2,
            'Al' :  3, 'Si' :  4, 'P'  :  5, 'S'  :  6, 'Cl' :  1, 'Ar' :  0,
            'K'  :  1, 'Ca' :  2, 'Sc' : 99, 'Ti' : 99, 'V'  : 99, 'Cr' : 99,
            'Mn' : 99, 'Fe' : 99, 'Co' : 99, 'Ni' : 99, 'Cu' : 99, 'Zn' : 99,
            'Ga' : 99, 'Ge' : 99, 'As' : 99, 'Se' : 99, 'Br' : 99, 'Kr' : 99,
            'Rb' : 99, 'Sr' : 99, 'Y'  : 99, 'Zr' : 99, 'Nb' : 99, 'Mo' : 99,
            'Tc' : 99, 'Ru' : 99, 'Rh' : 99, 'Pd' : 99, 'Ag' : 99, 'Cd' : 99,
            'In' : 99, 'Sn' : 99, 'Sb' : 99, 'Te' : 99, 'I'  : 99, 'Xe' : 99,
            'Cs' : 99, 'Ba' : 99, 'La' : 99, 'Ce' : 99, 'Pr' : 99, 'Nd' : 99,
            'Pm' : 99, 'Sm' : 99, 'Eu' : 99, 'Gd' : 99, 'Tb' : 99, 'Dy' : 99,
            'Ho' : 99, 'Er' : 99, 'Tm' : 99, 'Yb' : 99, 'Lu' : 99, 'Hf' : 99,
            'Ta' : 99, 'W'  : 99, 'Re' : 99, 'Os' : 99, 'Ir' : 99, 'Pt' : 99,
            'Au' : 99, 'Hg' : 99, 'Tl' : 99, 'Pb' : 99, 'Bi' : 99, 'Po' : 99,
            'At' : 99, 'Rn' : 99, 'Fr' : 99, 'Ra' : 99, 'Ac' : 99, 'Th' : 99,
            'Pa' : 99, 'U'  : 99, 'Np' : 99, 'Pu' : 99, 'Am' : 99, 'Cm' : 99,
            'Bk' : 99, 'Cf' : 99, 'Es' : 99, 'Fm' : 99, 'Md' : 99, 'No' : 99,
            'Lr' : 99, 'Rf' : 99, 'Db' : 99, 'Sg' : 99, 'Bh' : 99, 'Hs' : 99,
            'Mt' : 99, 'Ds' : 99, 'Rg' : 99, 'Cn' : 99, 'Uut': 99, 'Uuq': 99,
            'Uup': 99, 'Uuh': 99, 'Uus': 99, 'Uuo': 99, 'EP' : 99 }
